...
export declare function remoteProxyClientWorker(remoteProxyConnectionString: RemoteProxyConnectionString | undefined, binding: string, bindingType?: string, script?: () => string): {
